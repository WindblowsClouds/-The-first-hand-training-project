...
<script>
  ...
  export default {
    ...
    methods: {
      //排他操作，当点击时，点击的属性高亮，其他不亮
      changeActive(SaleAttrValue,AttrValueList){
      ...
      async addshopcar(){
       try {
        let result=  await this.$store.dispatch('AddAndUpdataShopCar',{skuId:this.$route.params.skuId,skuNum:this.skuNum})
        //简单的数据，可以通过query传输，但是比较复杂的数据如对象，可以通过本地存储

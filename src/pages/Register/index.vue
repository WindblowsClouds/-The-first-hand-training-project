    ...
    <div class="register">
      ...
      <div class="content">
        ...
        <input
          ...
          v-model="password"
          name="password"
          v-validate="{ required: true, regex: /^[1-9A-Zaz]{8,20}$/ }"
      ...
      <div class="content">
        ...
        <input
          ...
          :class="{ invalid: errors.has('passwordInfo') }"
        />
        <span class="error-msg">{{ errors.first("passwordInfo") }}</span>
      </div>
      <div class="controls">
        <input
          type="checkbox"
...
export default {
  ...
  methods: {
    ...
    async userRegister() {
      ...
      if (success) {
        try {
          const { phone, password, code, passwordInfo } = this;
          phone &&
            code &&

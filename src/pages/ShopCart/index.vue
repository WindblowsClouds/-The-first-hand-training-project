<template>
  <div class="cart">
    ...
    <div class="cart-main">
      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="cart of cartInfoList" :key="cart.id">
...
export default {
  ...
  methods: {
    ...
    handler: throttle(async function (type, disNum, cart) {
      ...
      //派发action
      try {
        await this.$store.dispatch("AddAndUpdataShopCar", {
          skuId: cart.skuId,
          skuNum: disNum,
        });
        this.getData();
    ...
    async changeChecked(cart,event){
      try {
        ...
        await this.$store.dispatch('getCartChecked',{skuId:cart.skuId,isChecked})
        this.getData()
      } catch (error) {
      alert(error.message)  
      }
